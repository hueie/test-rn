...
describe('MyButton', () => {
    describe('Rendering', () => {
        it('should match to snapshot', () => {
            const component = shallow(<MyButton label="test label"/>)
            expect(component).toMatchSnapshot()
        });
        it('should match to snapshot - Primary', () => {
            const component = shallow(<MyButton label="test label" primary />)
            expect(component).toMatchSnapshot("Primary button snapshot")
        });
        it('should match to snapshot - Secondary', () => {
            const component = shallow(<MyButton label="test label" primary={false} />)
        ...
        describe('onPressHandler', () => {
            ...
            describe('onPressHandler2', () => {
                ...
                it('should not call openURL if url is nor provided', () => {
                    const innerInstance = shallow(<MyButton label="test label" onPress={mockOnPress} />).instance();
